import sys
sys.path
sys.path.append('C:/Udemy/Pro Data Science in Python')
...
x = DImage.Matrix_CV_ML3D("C:/Udemy/Pro Data Science in Python/BoltsNuts/train",65,50)
x.build_ML_matrix()
...
test = DImage.Matrix_CV_ML3D("C:/Udemy/Pro Data Science in Python/BoltsNuts/test",65,50)
